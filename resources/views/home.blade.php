    ...
    <div class="container flex h-[93vh] font-family" id="home-content">
        ...
        <div class="w-1/2  flex h-full items-center " id="content">
            <div class="h-4/5 xl:h-full flex flex-col justify-around  p-4 ps-0">
                ...
                <div class="card shadow-xl pb-4 ps-5 text-2xl font-medium">Great Execution, Pixel Perfect Work Delivered by Team -</div>
                ...
                <a href="#" class="btn btn-wide border-b-neutral-950">Get Started (Join for free)<i class="fa-solid fa-right-long"></i></a>
        ...
        <div class="w-1/2 h-full" id="bg-photo">
            <img src="{{asset('storage/images/officebg.png')}}" alt="" style="width: 100%; height: 100%; object-fit: cover">
        </div>
        ...
        <div class="card bg-base-100 w-48 shadow-xl rounded-none" id="login-box">
            <div class="card-body">
                ...
                <a class="link link-hover text-[10px] text-end">Sign Up <i class="fa-solid fa-arrow-right"></i></a>
            </div>
        </div>
    </div>
</div>
