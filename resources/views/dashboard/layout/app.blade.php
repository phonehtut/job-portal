...
<div class="md:container md:mx-auto h-screen" >
    ...
    <form action="{{ route('search') }}" method="GET" class="flex items-center mt-3">
        <input type="text" name="search" placeholder="Search here" class="input w-full border border-neutral-950 me-3"/>
